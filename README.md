...
> Lineage: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\pq-migration-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\pq-migration-jobs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package pq-migration-jobs -Apply
