...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'scope', 'target_policy_id', 'target_algo_id', 'selection', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_by', 'created_at' ];
    }
    ...
    {
        return [ 'id', 'scope', 'target_policy_id', 'target_algo_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_by', 'created_at' ];
    }
    ...
    protected function joinable(): array
    {
        ...
        return [ 'encryption_policies' => 'j0', 'crypto_algorithms' => 'j1', 'users' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PqMigrationJobs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PqMigrationJobs\Definitions::softDeleteColumn();
