...
use BlackCat\Database\Packages\PqMigrationJobs\Repository\PqMigrationJobRepository;
...
{
    private PqMigrationJobRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PqMigrationJobRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PqMigrationJobs\Dto\PqMigrationJobDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PqMigrationJobs\Dto\PqMigrationJobDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PqMigrationJobs\Dto\PqMigrationJobDto|null
    {
