...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'pq_migration_jobs'; }
    public static function contractView(): string { return 'vw_pq_migration_jobs'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'scope', 'target_policy_id', 'target_algo_id', 'selection', 'scheduled_at', 'started_at', 'finished_at', 'status', 'processed_count', 'error', 'created_by', 'created_at' ]; }
    ...
    public static function jsonColumns(): array { return [ 'selection' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'target_policy_id', 'target_algo_id', 'processed_count', 'created_by' ]; }
